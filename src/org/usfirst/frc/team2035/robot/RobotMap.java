...
public class RobotMap {
    ...
    public static final int GRABBER_SYSTEM_MOTOR_PWM = 8; //8 is TBD
    /*
     * Joysticks
     */
  ...
  //Joystick buttons
	...
	public static final JoystickButton GRABBER_LOWER = new JoystickButton(DRIVER_JOYSTICK_A, 3);
	public static final JoystickButton GRABBER_RAISE = new JoystickButton(DRIVER_JOYSTICK_A, 4);
	public static final JoystickButton GRABBER_HOLD = new JoystickButton(DRIVER_JOYSTICK_A, 5);
	public static final JoystickButton GRABBER_RELEASE = new JoystickButton(DRIVER_JOYSTICK_A, 6);
	/*
	 * Solenoids
	 */
	public static final int PCM_ID_DRIVER = 0;
	public static final int PCM_ID_GEAR = 1;
	public static final int GRABBER_PCM = 6; //TBD
	...
	public static final double GRABBER_DOWN = -1.0;
	public static final double GRABBER_UP = 1.0;
}
